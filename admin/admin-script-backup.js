...
class AdminPanel {
    ...
    loadMockCompaniesAndJobs() {
        ...
        // Applications will be loaded from API, no mock data needed
                job_id: 1,
                job_title: 'Fractional Chief Technology Officer',
                company_name: 'TechStart Inc.',
                first_name: 'Sarah',
                last_name: 'Johnson',
                email: 'sarah.johnson@email.com',
                phone: '+1-555-0101',
                applied_at: '2024-01-16 10:30:00',
                status: 'shortlisted',
                rating: 5,
                cover_letter: 'I am excited to apply for the Fractional CTO position at TechStart Inc. With over 12 years of experience leading technology teams at high-growth startups, I have successfully scaled engineering organizations from 5 to 50+ developers while maintaining code quality and delivery velocity.\n\nIn my previous role as VP of Engineering at DataFlow Solutions, I led the complete migration to a microservices architecture, reducing deployment time by 75% and improving system reliability to 99.9% uptime. I also implemented agile development practices that increased team productivity by 40%.\n\nKey achievements include:\n• Led technical due diligence for $50M Series B funding round\n• Built and managed distributed teams across 3 time zones\n• Established DevOps culture resulting in daily deployments\n• Mentored 15+ senior developers into team leads\n\nI am particularly drawn to fractional roles because they allow me to leverage my experience across multiple companies simultaneously, helping startups avoid common scaling pitfalls while building robust technical foundations.\n\nI would welcome the opportunity to discuss how my experience can help TechStart Inc. achieve its technology goals.',
                resume_filename: 'Sarah_Johnson_Resume_CTO.pdf',
                resume_file_path: '/uploads/resumes/sarah_johnson_cto_resume.pdf',
                resume_file_size: 245760
            },
            {
                id: 2,
                job_id: 1,
                ...
                phone: '+1-555-0102',
                applied_at: '2024-01-17 09:15:00',
                status: 'interviewing',
                rating: 5,
                cover_letter: 'With over 15 years of technology leadership experience in both startups and Fortune 500 companies, I am excited to contribute as a Fractional CTO for TechStart Inc.\n\nMy background spans full-stack development, cloud architecture, and executive leadership. At my previous company, CloudTech Innovations, I served as CTO for 6 years, growing the engineering team from 8 to 120 people while scaling our platform to serve over 2 million users.\n\nRelevant experience:\n• Designed and implemented scalable cloud infrastructure on AWS\n• Led digital transformation initiatives resulting in 60% cost reduction\n• Established security protocols achieving SOC 2 Type II compliance\n• Built AI/ML capabilities that increased customer engagement by 45%\n• Successfully navigated 3 funding rounds totaling $85M\n\nI am passionate about helping growing companies establish strong technical foundations while avoiding the common pitfalls of rapid scaling. My approach combines strategic thinking with hands-on technical expertise.\n\nI believe fractional leadership is the future of executive roles, allowing companies to access senior talent while maintaining flexibility. I would love to discuss how I can help TechStart Inc. accelerate its growth.',
                resume_filename: 'David_Thompson_CTO_Resume.pdf',
                resume_file_path: '/uploads/resumes/david_thompson_cto_resume.pdf',
                resume_file_size: 312540
            },
            {
                id: 3,
                job_id: 2,
                job_title: 'Fractional Chief Marketing Officer',
                company_name: 'GrowthCo',
                first_name: 'Emily',
                last_name: 'Rodriguez',
                email: 'emily.rodriguez@email.com',
                phone: '+1-555-0103',
                applied_at: '2024-01-19 16:45:00',
                status: 'reviewed',
                rating: 4,
                cover_letter: 'As a marketing executive with a proven track record of driving growth for B2B SaaS companies, I am thrilled to apply for the Fractional CMO position at GrowthCo.\n\nIn my 10+ years of marketing leadership, I have consistently delivered results that directly impact the bottom line. Most recently, as CMO at ScaleUp Solutions, I led the marketing team through a period of explosive growth, increasing MRR from $500K to $4.2M in 18 months.\n\nKey accomplishments:\n• Developed and executed go-to-market strategy for 3 major product launches\n• Built marketing qualified lead pipeline increasing by 275%\n• Implemented marketing automation reducing CAC by 40%\n• Established thought leadership program resulting in 15 industry awards\n• Led rebranding initiative that improved brand recognition by 65%\n\nMy approach to fractional marketing leadership focuses on quickly identifying growth levers and implementing systems that generate sustainable results. I believe in data-driven decision making and building marketing engines that continue to perform.\n\nI am excited about the opportunity to bring my expertise to GrowthCo and help accelerate your growth trajectory. I would welcome the chance to discuss your specific marketing challenges and how I can help solve them.',
                resume_filename: 'Emily_Rodriguez_CMO_Resume.pdf',
                resume_file_path: '/uploads/resumes/emily_rodriguez_cmo_resume.pdf',
                resume_file_size: 287340
            }
        ];
    ...
    loadEmployerRequests() {
        ...
        let filteredRequests = this.employerRequests;
    ...
    assignRequest(requestId) {
        const staffMembers = ['recruiter1', 'recruiter2', 'manager1', 'admin'];
        const assignment = prompt('Assign to staff member:\n' + staffMembers.join(', '));
        
        if (assignment && staffMembers.includes(assignment)) {
            const request = this.employerRequests.find(r => r.id === requestId);
            if (request) {
                request.assigned_to = assignment;
                this.showNotification(`Request assigned to ${assignment}`, 'success');
                this.viewRequest(requestId); // Refresh the view
            }
        } else if (assignment) {
            this.showNotification('Invalid staff member. Please use: ' + staffMembers.join(', '), 'warning');
        }
    }
...
Flexi-Careers Team`;
    ...
    downloadResume(applicationId) {
        ...
        const pdfContent = this.generateSamplePDF(app, 'resume');
        this.downloadFile(pdfContent, app.resume_filename, 'application/pdf');
